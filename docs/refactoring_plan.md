...
- [ ] `tests/sdk/test_mcp_server.py` — 1488 LOC
- [ ] `tests/backend/test_chatkit_store_sqlite.py` — 1340 LOC
- [ ] `apps/canvas/src/features/workflow/pages/workflow-gallery.tsx` — 1067 LOC
- [ ] `tests/test_vault.py` — 1058 LOC
- [ ] `apps/canvas/src/features/workflow/components/panels/node-inspector.tsx` — 1030 LOC
- [ ] `apps/canvas/src/features/workflow/lib/node-schemas.ts` — 1005 LOC
...
- [ ] `tests/backend/test_service_token_repository.py` — 785 LOC
- [ ] `apps/canvas/src/features/workflow/components/panels/sidebar-panel.tsx` — 756 LOC
- [ ] `tests/test_triggers_webhook.py` — 752 LOC
- [ ] `tests/sdk/test_workflow_cli_helpers.py` — 741 LOC
- [ ] `apps/backend/src/orcheo_backend/app/chatkit_store_sqlite.py` — 727 LOC
- [ ] `apps/canvas/src/features/workflow/components/panels/workflow-execution-history.tsx` — 679 LOC
...
- [ ] `tests/sdk/test_client.py` — 589 LOC
- [ ] `tests/backend/test_service_token_endpoints.py` — 576 LOC
- [ ] `apps/canvas/src/features/support/pages/help-support.tsx` — 573 LOC
- [ ] `apps/backend/src/orcheo_backend/app/chatkit_service.py` — 571 LOC
- [ ] `apps/canvas/src/features/workflow/data/workflow-data.ts` — 569 LOC
...
- [ ] `apps/canvas/src/features/account/pages/settings.tsx` — 518 LOC
- [ ] `tests/nodes/test_ai.py` — 517 LOC
- [ ] `tests/nodes/test_mongodb.py` — 507 LOC
...
- [ ] `tests/graph/test_builder.py` — 473 LOC
- [ ] `src/orcheo/nodes/data.py` — 468 LOC
