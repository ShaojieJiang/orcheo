...
- [ ] Stand up ChatKit integration (frontend demo, backend endpoint, LangGraph workflow, SQLite storage) per [ChatKit Integration Design](./chatkit_integration_design.md).
