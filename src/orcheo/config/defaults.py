...
_DEFAULTS: dict[str, object] = {
    ...
    "TELEMETRY_SERVICE_NAME": "orcheo-backend",
    "TELEMETRY_EXPORTER_OTLP_ENDPOINT": None,
    "TELEMETRY_EXPORTER_OTLP_HEADERS": None,
    "TELEMETRY_EXPORTER_OTLP_INSECURE": False,
    "TELEMETRY_EXPORTER_OTLP_TIMEOUT": 10.0,
    "TELEMETRY_SAMPLER": "always_on",
    "TELEMETRY_SAMPLER_RATIO": 1.0,
}
