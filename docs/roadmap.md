...
- [x] Migrate the legacy canvas app onto the updated React Flow foundation, restoring minimap, snapping, and chat affordances while preserving node compatibility.
