...
- [ ] Ship ChatKit integration across frontend example, backend endpoint, LangGraph stub, and SQLite chat store per [ChatKit Integration Design](./chatkit_integration_design.md).
